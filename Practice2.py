...
def student_signup():
    while True:
        ...
        if not roll.isdigit():
            print("Roll number must be digits only!")
            continue
...
""")
            ...
            print(f"Fee Status : {students[roll]['fee_status']}")
...
""")
            ...
            roll = input("Enter roll number: ")
            if roll in students:
                status = input("Enter fee status (Paid/Pending): ")
                students[roll]["fee_status"] = status
                print(f"{GREEN}Fee status updated!{RESET}")
            else:
            ...
            if roll in students:
                ...
                students[roll]["attendance"] = att
                print(f"{GREEN}Attendance updated!{RESET}")
            else:
                print("Student not found!")
